...
public class GUIDUtil {
    ...
    public static void main(String[] args){
        ...
        String ticket = GUIDUtil.genRandomGUID();
        //String ticket = "0A301228E5906F4E0CF9253DEDD71C83";
        System.out.println("ticket=" + ticket);
//        String encryptTicket = AesUtil.encrypt(ticket);
//        System.out.println("encryptTicket=" + encryptTicket);
    }
